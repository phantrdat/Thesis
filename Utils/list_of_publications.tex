...
\begin{enumerate}
    ...
    \item \textit{Chapter \ref{chap:neural-cbo}}: Phan-Trong, D., Tran, H. T., \& Gupta, S. (2025). Black-box Optimization with Unknown Constraints via Overparameterized Deep Neural Networks. In The 41st Conference on Uncertainty in Artificial Intelligence.  
